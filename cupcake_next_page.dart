...
class cupcake_next_page extends StatefulWidget {
  final cupcakedetails cupcakeitems;
  const cupcake_next_page({super.key,required this.cupcakeitems});

  @override
  State<cupcake_next_page> createState() => _cupcake_next_pageState();
}

class _cupcake_next_pageState extends State<cupcake_next_page> {
double price=11.5;
  int pcs =3;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.cupcakeitems.color,
       ...
       body: SingleChildScrollView(
         child: Container( 
           ...
           //image
               ...
               Hero(
                 tag: widget.cupcakeitems,
                 child: Image.asset(
                  height: 300,
                   widget.cupcakeitems.image)),
           SizedBox(height: 10,),
           ...
           //name
               ...
               Center(
                 child: Text(widget.cupcakeitems.name,style: GoogleFonts.creepster(
                                 fontSize: 45,
