...
class jar_next_page extends StatefulWidget {
  final jardetails jaritems;
  const jar_next_page({super.key,required this.jaritems});

  @override
  State<jar_next_page> createState() => _jar_next_pageState();
}

class _jar_next_pageState extends State<jar_next_page> {
double price=6.50 ;
  int pcs =3;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.jaritems.color,
       ...
       body: SingleChildScrollView(
         child: Container( 
           ...
           //name
               ...
               Center(
                 child: Text(widget.jaritems.name,style: GoogleFonts.creepster(
                                 fontSize: 45,
           ...
           //price and pieces
             ...
             Container(padding: EdgeInsets.symmetric(horizontal: 30),
               ...
               child: Row(children: [
                 ...
                 Text("$pcs  jars",style: TextStyle(color: Colors.brown.shade100,fontSize: 17),),
                 IconButton(onPressed: (){
                   setState(() {
                     pcs++;
                     price=(price+3) ;
           ...
           Container(
             ...
             children: [
               ...
               SizedBox(height: 10,),
               Text("Chocolates,butter,sugar,icecream,buttermilk,vinegar,oreo,fruits",style:  GoogleFonts.smoochSans(
                                 fontSize: 25,
