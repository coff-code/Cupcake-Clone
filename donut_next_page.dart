...
class donut_next_page extends StatefulWidget {
  final donutdetails donutitems;
  const donut_next_page({super.key,required this.donutitems});

  @override
  State<donut_next_page> createState() => _donut_next_pageState();
}

class _donut_next_pageState extends State<donut_next_page> {
double price=11.5;
  int pcs =3;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.donutitems.color,
       ...
       body: SingleChildScrollView(
         child: Container( 
           ...
           //image
               ...
               Hero(
                 tag: widget.donutitems,
                 child: Image.asset(
                  height: 300,
                   widget.donutitems.image)),
           SizedBox(height: 10,),
           ...
           //name
               ...
               Center(
                 child: Text(widget.donutitems.name,style: GoogleFonts.creepster(
                                 fontSize: 45,
           ...
           //price and pieces
             ...
             Container(padding: EdgeInsets.symmetric(horizontal: 30),
               ...
               child: Row(children: [
                 ...
                 Text(widget.donutitems.pcs,style: TextStyle(color: Colors.brown.shade100,fontSize: 17),),
                 IconButton(onPressed: (){
                   setState(() {
                      pcs++;
                     price=price+3.1;
